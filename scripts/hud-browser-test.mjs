...
try {
  ...
  console.log('HUD browser T2 PASS: menu, dock, gallery intent, empty/failed/successful commit, discard, contextual rails, LOG absent, landscape dock/handle, orientation state, handedness, 12-second centered counter-rotation, reduced motion.');
} finally {
